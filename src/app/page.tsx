                  ...
                  <div className="space-y-7">
                    {[
                      ...
                      },
                      {
                        ...
                        label: "Email",
                        content: (
                          <a href="#contact" className="hover:text-[#F47920] transition-colors">
                            Use contact form →
                          </a>
                        ),
                      },
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
            ...
            <div className="md:col-span-2">
              ...
              <div className="flex items-center gap-3">
                {[
                  {
                    href: "#", // TODO: replace with your Facebook URL
                    label: "Facebook",
                    icon: (
                  ...
                  {
                    href: "#", // TODO: replace with your X (Twitter) URL
                    label: "X (Twitter)",
                    icon: (
                      <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor" aria-hidden="true">
                  ...
                  {
                    href: "#", // TODO: replace with your YouTube URL
                    label: "YouTube",
                    icon: (
                      <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor" aria-hidden="true">
                        <path d="M22.54 6.42a2.78 2.78 0 0 0-1.95-1.96C18.88 4 12 4 12 4s-6.88 0-8.59.46a2.78 2.78 0 0 0-1.95 1.96A29 29 0 0 0 1 12a29 29 0 0 0 .46 5.58A2.78 2.78 0 0 0 3.41 19.6C5.12 20 12 20 12 20s6.88 0 8.59-.46a2.78 2.78 0 0 0 1.95-1.95A29 29 0 0 0 23 12a29 29 0 0 0-.46-5.58z" />
                        <polygon fill="#050D16" points="9.75 15.02 15.5 12 9.75 8.98 9.75 15.02" />
                      </svg>
                    ),
                  },
                  {
                  ...
                  <a
                    ...
                    target="_blank"
                    className="w-9 h-9 rounded-lg bg-white/5 hover:bg-[#F47920] text-white/40 hover:text-white flex items-center justify-center transition-[background-color,color] duration-200"
                  >
                    {icon}
                  </a>
                ))}
            ...
            <div>
              ...
              <div className="space-y-3 text-sm text-white/40">
                ...
                <p><a href="#contact" className="hover:text-[#F47920] transition-colors">Email Us</a></p>
              </div>
            </div>
          </div>
